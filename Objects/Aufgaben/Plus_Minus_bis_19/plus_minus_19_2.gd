...
func _erzeuge_aufgabe() -> void:
	...
	if operator == 0: #+
		summandLinks1 = randi() %10 +10
		summandLinks2 = randi() %10 +10
		summandOben3 = randi() %9 +1
		summandOben4 = randi() %9 +1
		while (summandLinks1 + summandOben3 > 19) or (summandLinks1 + summandOben4 > 19) or (summandLinks2 + summandOben3 > 19) or (summandLinks2 + summandOben4 > 19) or (summandLinks1 == summandLinks2) or (summandOben3 == summandOben4):
			summandLinks1 = randi() %10 +10
			summandLinks2 = randi() %10 +10
			summandOben3 = randi() %9 +1
			summandOben4 = randi() %9 +1
	...
	_zahlen_eintragen(operator, summandLinks1, summandLinks2, summandOben3, summandOben4)
