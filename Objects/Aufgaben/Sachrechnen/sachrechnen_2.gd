...
func _aufgabe_anzeigen(zahl1 : int, ergebnis : int) -> void:
	...
	if zahl1 < 10:
		...
		$AufgabenPanel/PanelLinks/Z.visible = false
		$AufgabenPanel/PanelLinks/E.texture = abbildung1
		$AufgabenPanel/PanelRechts/E.texture = abbildung2
		$AufgabenPanel/PanelLinks/E.position.x = 180
		$AufgabenPanel/Eingabefeld_Zahl1.laenge = 1
		$AufgabenPanel/Eingabefeld_Zahl1._resize_field()
		$AufgabenPanel/Eingabefeld_Zahl1.position.x += 15
	else:
		match rng:
			0:
		...
		abbildung2 = load(pfad2)
		$AufgabenPanel/PanelLinks/E.texture = abbildung1
		$AufgabenPanel/PanelRechts/Z.visible = false
		$AufgabenPanel/PanelRechts/E.texture = abbildung2
		$AufgabenPanel/PanelRechts/E.position.x = 180
		$AufgabenPanel/Eingabefeld_Ergebnis.laenge = 1
		$AufgabenPanel/Eingabefeld_Ergebnis._resize_field()
