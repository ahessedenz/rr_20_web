...
func _erzeuge_aufgabe() -> void:
	...
	var operator3 : int = randi() %2
	if operator1 == 0 and operator2 == 0 and operator3 == 0: # +++
		zahl1 = randi() %15 +1
		zahl2 = randi() %9 +1
		zahl3 = randi() %9 +1
		zahl4 = randi() %9 +1
		while zahl1 + zahl2 + zahl3 + zahl4 >= 20:
			zahl1 = randi() %15 +1
			zahl2 = randi() %9 +1
			zahl3 = randi() %9 +1
			zahl4 = randi() %9 +1
	elif operator1 == 0 and operator2 == 0 and operator3 == 1: # ++-
		zahl1 = randi() %15 +1
		zahl2 = randi() %9 +1
		zahl3 = randi() %9 +1
		zahl4 = randi() %9 +1
		while (zahl1 + zahl2 + zahl3 >= 20) or (zahl1 + zahl2 + zahl3 - zahl4 <= 0):
			zahl1 = randi() %15 +1
			zahl2 = randi() %9 +1
			zahl3 = randi() %9 +1
			zahl4 = randi() %9 +1
	elif operator1 == 0 and operator2 == 1 and operator3 == 0: # +-+
		zahl1 = randi() %15 +1
		zahl2 = randi() %9 +1
		zahl3 = randi() %9 +1
		zahl4 = randi() %9 +1
		while (zahl1 + zahl2 >= 20) or (zahl1 + zahl2 - zahl3 <= 0) or (zahl1 + zahl2 - zahl3 + zahl4 >= 20):
			zahl1 = randi() %15 +1
			zahl2 = randi() %9 +1
			zahl3 = randi() %9 +1
			zahl4 = randi() %9 +1
	elif operator1 == 0 and operator2 == 1 and operator3 == 1: # +--
		zahl1 = randi() %15 +1
		zahl2 = randi() %9 +1
		zahl3 = randi() %9 +1
		zahl4 = randi() %9 +1
		while (zahl1 + zahl2 >= 20) or (zahl1 + zahl2 - zahl3 <= 0) or (zahl1 + zahl2 - zahl3 - zahl4 <= 0):
			zahl1 = randi() %15 +1
			zahl2 = randi() %9 +1
			zahl3 = randi() %9 +1
			zahl4 = randi() %9 +1
	elif operator1 == 1 and operator2 == 0 and operator3 == 0: # -++
		var rng : int = randi() %2
		if rng == 0:
			zahl1 = randi() %20 +1
			zahl2 = randi() %9 +1
			zahl3 = randi() %9 +1
			zahl4 = randi() %9 +1
			while (zahl1 - zahl2 <= 0) or (zahl1 - zahl2 + zahl3 >= 20) or (zahl1 - zahl2 + zahl3 + zahl4 >= 20):
				zahl1 = randi() %20 +1
				zahl2 = randi() %9 +1
				zahl3 = randi() %9 +1
				zahl4 = randi() %9 +1
			...
			while (zahl1 - zahl2 <= 0) or (zahl1 - zahl2 + zahl3 >= 20) or (zahl1 - zahl2 + zahl3 + zahl4 >= 20):
				...
				zahl3 = randi() %9 +1
				zahl4 = randi() %9 +1
	elif operator1 == 1 and operator2 == 0 and operator3 == 1: # -+-
		var rng : int = randi() %2
		if rng == 0:
			zahl1 = randi() %20 +1
			zahl2 = randi() %9 +1
			zahl3 = randi() %9 +1
			zahl4 = randi() %9 +1
			while (zahl1 - zahl2 <= 0) or (zahl1 - zahl2 + zahl3 >= 20) or (zahl1 - zahl2 + zahl3 - zahl4 <= 0):
				zahl1 = randi() %20 +1
				zahl2 = randi() %9 +1
				zahl3 = randi() %9 +1
				zahl4 = randi() %9 +1
			...
			while (zahl1 - zahl2 <= 0) or (zahl1 - zahl2 + zahl3 >= 20) or (zahl1 - zahl2 + zahl3 - zahl4 <= 0):
				...
				zahl3 = randi() %9 +1
				zahl4 = randi() %9 +1
	elif operator1 == 1 and operator2 == 1 and operator3 == 0: # --+
		var rng : int = randi() %2
		if rng == 0:
			zahl1 = randi() %20 +1
			zahl2 = randi() %9 +1
			zahl3 = randi() %9 +1
			zahl4 = randi() %9 +1
			while (zahl1 - zahl2 <= 0) or (zahl1 - zahl2 - zahl3 <= 0) or (zahl1 - zahl2 - zahl3 + zahl4 >= 20):
				zahl1 = randi() %20 +1
				zahl2 = randi() %9 +1
				zahl3 = randi() %9 +1
				zahl4 = randi() %9 +1
			...
			while (zahl1 - zahl2 <= 0) or (zahl1 - zahl2 - zahl3 <= 0) or (zahl1 - zahl2 - zahl3 + zahl4 >= 20):
				...
				zahl3 = randi() %9 +1
				zahl4 = randi() %9 +1
	elif operator1 == 1 and operator2 == 1 and operator3 == 1: # ---
		var rng : int = randi() %2
		if rng == 0:
			zahl1 = randi() %20 +1
			zahl2 = randi() %9 +1
			zahl3 = randi() %9 +1
			zahl4 = randi() %9 +1
			while (zahl1 - zahl2 <= 0) or (zahl1 - zahl2 - zahl3 <= 0) or (zahl1 - zahl2 - zahl3 - zahl4 <= 0):
				zahl1 = randi() %20 +1
				zahl2 = randi() %9 +1
				zahl3 = randi() %9 +1
				zahl4 = randi() %9 +1
			...
			while (zahl1 - zahl2 <= 0) or (zahl1 - zahl2 - zahl3 <= 0) or (zahl1 - zahl2 - zahl3 - zahl4 <= 0):
				...
				zahl3 = randi() %9 +1
				zahl4 = randi() %9 +1
	_aufgabe_anzeigen(zahl1, zahl2, zahl3, zahl4, operator1, operator2, operator3)
	_setze_gesucht(zahl1, zahl2, zahl3, zahl4, operator1, operator2, operator3)
	$AufgabenPanel/Eingabefeld.setActive(true)


func _aufgabe_anzeigen(zahl1 : int, zahl2 : int, zahl3 : int, zahl4 : int, operator1 : int, operator2 : int, operator3 : int) -> void:
	$AufgabenPanel/Zahl1/Zahl1.text = str(zahl1)
	$AufgabenPanel/Zahl2/Zahl2.text = str(zahl2)
	$AufgabenPanel/Zahl3/Zahl3.text = str(zahl3)
	$AufgabenPanel/Zahl4/Zahl4.text = str(zahl4)
	if zahl1 < 10:
	...
	if operator2 == 0:
		...
		$AufgabenPanel/Operator2.text = "-"
	if operator3 == 0:
		$AufgabenPanel/Operator3.text = "+"
	else:
		$AufgabenPanel/Operator3.text = "-"


func _setze_gesucht(zahl1 : int, zahl2 : int, zahl3 : int, zahl4 : int, operator1 : int, operator2 : int, operator3 : int) -> void:
	if operator1 == 0 and operator2 == 0 and operator3 == 0: # +++
